	...
	*/
	...
	/**
	   ...
	   @param  mySign        生成的签名
	       @return 0表示成功
	*/
	public static int appSignOnce(String appId, String secret_id, String secret_key, String userid, String url, StringBuffer mySign) {
	...
	private static String appSignature(int appId, String secretId, String secretKey, long expired, String fileId, String bucketName) {
		...
		int rdm = Math.abs(new Random().nextInt()); //无符号10进制数，最长10位
		...
		return Base64Util.encode(new String(all));
	}
	...
	private static int appSignBase(String appId, String secret_id, String secret_key, long expired, String userid, String url, StringBuffer mySign) {
		...
		mySign.append(Base64Util.encode(new String(all)));
